        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <SpaIcon className="text-green-400 text-3xl" />
            ...
            <div className="flex space-x-4">
              <FacebookIcon className="text-gray-400 hover:text-green-400 cursor-pointer transition-colors" />
              <InstagramIcon className="text-gray-400 hover:text-green-400 cursor-pointer transition-colors" />
              <TwitterIcon className="text-gray-400 hover:text-green-400 cursor-pointer transition-colors" />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-2">
                <LocationOnIcon className="text-green-400 mt-1" />
